...
def error_wire(circuit_output):
    ...
    # array used to hold probabilites of a particular qubit flipping
    qubit_flip_probs = np.zeros([4])
    
    # probability no qubit was flipped
    qubit_flip_probs[0] = circuit_output[0] + circuit_output[4]    
    # probability of first qubit flipped
    qubit_flip_probs[1] = circuit_output[3] + circuit_output[7]
    # probability of second qubit flipped    
    qubit_flip_probs[2] = circuit_output[2] + circuit_output[6] 
    # probability of third qubit flipped
    qubit_flip_probs[3] = circuit_output[1] + circuit_output[5]
    
    return qubit_flip_probs
